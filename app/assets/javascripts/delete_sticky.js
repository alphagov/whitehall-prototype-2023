...
this.Element && function(t)
	...
	}(0, function()
	{
		...
		(function()
		{
			...
			}() || (a = Object.defineProperty, l = Object.prototype.hasOwnProperty("__defineGetter__"), c = "Getters & setters cannot be defined on this javascript engine", u = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function d(t, e, n)
			{
				...
				"DOMTokenList" in this && (!("classList" in (t = document.createElement("x"))) || !t.classList.toggle("x", !1) && !t.className) || ("DOMTokenList" in (e = this) && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function()
				{
					...
					return function(i, r)
					{
						...
						}, s.add = function()
						{
							...
							for (var t, e, n = 0, o = t.length; n < o; ++n) e = t[n], l[e] || (a.push(e), l[e] = !0);
						...
						{
							return d.apply(s, [t]), p !== e ? e ? (s.add(t), !0) : (s.remove(t), !1) : l[t] ? (s.remove(t), !1) : (s.add(t), !0)
						}, s
					}
			...
			function()
			{
				"Element" in this && "HTMLElement" in this || function()
				{
					function t()
					{
						return r-- || clearTimeout(e), !(!document.body || document.body.prototype || !/(complete|interactive)/.test(document.readyState)) && (c(document, !0), e && document.body.prototype && clearTimeout(e), !!document.body.prototype)
					}
					if (!window.Element || window.HTMLElement)
					{
						window.Element = window.HTMLElement = new Function("return function Element() {}")();
						var e, n = document.appendChild(document.createElement("body")),
						...
						a.attachEvent("onpropertychange", function(t)
						{
							...
							l[n] = i
						}), a.constructor = Element, a.hasAttribute || (a.hasAttribute = function s(t)
						{
							return null !== this.getAttribute(t)
						}), t() || (document.onreadystatechange = t, e = setInterval(t, 25)), document.createElement = function d(t)
						{
	...
	function(t)
	{
		...
		}, e.prototype.construct.tbody = function()
		{
			...
			for (var e = this.$table.querySelectorAll("tbody tr"), n = 0; n < e.length; n++)
			{
				...
				for (var i = "", r = e[n].querySelectorAll("th, td"), s = 0; s < r.length; s++) i += '<div class="mc-td">', i += r[s].innerHTML, i += "</div>";
		...
		}, e.prototype.addToggleClick = function(o, i, r, s)
		{
			...
			this.toggleLink.addEventListener("click", function(t)
			{
				...
				a.$graphContainer.classList.toggle("mc-hidden"), a.$table.classList.toggle("mc-hidden"), e.innerHTML = e.innerHTML === i ? o : i, n.innerHTML = n.innerHTML === s ? r : s
			})
					...
					for (var u = 0, d = 0; d < l; d++)
					{
						...
						if (this.utils.isFloat(h))
						{
							var f = parseFloat(h, 10),
								m = Math.abs(f);
							0 === f && p.classList.add("mc-bar-zero"), this.options.negative && (this.utils.isNegative(f) ? (p.classList.add("mc-bar-negative"), e < m && (e = m)) : p.classList.add("mc-bar-positive")), f = m, this.options.stacked ? u += f : (u = f, t.push(f))
						}
					}
				}
	...
	function(s)
	{
		...
		t.prototype.init = function()
		{
			...
			{
				var o = t[n].className; - 1 === o.indexOf("mc-chart") && -1 === o.indexOf("js-barchart-table-init") && e.push(t[n])
			}
			for (var i = 0; i < e.length; i++)
			{
				...
				}).init(), r.className = r.className + " js-barchart-table-init"
			}
	...
	function()
	{
		...
		}, l.prototype.setupVideo = function(t)
		{
			...
			s.className += "gem-c-govspeak__youtube-video", s.innerHTML = '<span id="' + e + '" data-video-id="' + o + '"></span>', t.title = n.textContent, r.replaceChild(s, i), this.insertVideo(e, t)
		...
		{
			l.playerApiReady = !0;
			for (var t = 0; t < l.queuedInserts.length; t++) l.queuedInserts[t].call()
	...
	}(this, function()
	{
		...
		function r(t, e)
		{
			...
			{
				var i = o.split(".");
				if (Object.prototype.hasOwnProperty.call(t, o) && i[0] === e) 1 < i.length && i.shift(), n[i.join(".")] = t[o]
			}
			return n
		}
		...
		s.prototype.t = function(t, e)
			{
				...
				return t
			}, s.prototype.replacePlaceholders = function(t, o)
			{
				var i;
				return this.hasIntlNumberFormatSupport() && (i = new Intl.NumberFormat(this.locale)), t.replace(/%{(.\S+)}/g, function(t, e)
				{
					if (Object.prototype.hasOwnProperty.call(o, e))
					{
						var n = o[e];
						return !1 === n ? "" : "number" == typeof n && i ? i.format(n) : n
					}
			...
			}, s.prototype.getPluralRulesForLocale = function()
			{
				...
				for (var n in s.pluralRulesMap)
					if (Object.prototype.hasOwnProperty.call(s.pluralRulesMap, n))
						for (var o = s.pluralRulesMap[n], i = 0; i < o.length; i++)
			...
			function()
			{
				"bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind",
				{
					value: function L(e)
					{
						...
						for (var y, b = h.call(arguments, 1), v = function()
							{
								if (this instanceof y)
								{
									var t = g.apply(this, f.call(b, h.call(arguments)));
									return o(t) === t ? t : this
								}
								return g.apply(e, f.call(b, h.call(arguments)))
							}, E = w(0, g.length - b.length), S = [], k = 0; k < E; k++) m.call(S, "$" + k);
						return y = Function("binder", "return function (" + S.join(",") + "){ return binder.apply(this, arguments); }")(v), g.prototype && (s.prototype = g.prototype, y.prototype = new s, s.prototype = null), y
					}
				})
			}.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global ||
			{}),
		...
		}, t.prototype.constructHeaderMarkup = function(t, e)
		{
			...
			if (h.classList.add(this.upChevronIconClass), d.appendChild(h), p.classList.add(this.sectionShowHideTextClass), d.appendChild(p), r.appendChild(l), r.appendChild(this.getButtonPunctuationEl()), null != i)
			{
				...
				for (var w = 0, g = i.attributes.length; w < g; ++w)
				{
					var y = i.attributes.item(w).nodeName,
						b = i.attributes.item(w).nodeValue;
					f.setAttribute(y, b)
				}
		...
		}, t.prototype.setExpanded = function(t, e)
		{
			...
			s.push(l), i.setAttribute("aria-label", s.join(" , ")), t ? (e.classList.add(this.sectionExpandedClass), n.classList.remove(this.downChevronIconClass)) : (e.classList.remove(this.sectionExpandedClass), n.classList.add(this.downChevronIconClass));
	...
	function(t)
	{
		...
		e.prototype.init = function()
		{
			...
			if (e) try
			{
				...
				for (var n = JSON.parse(e), o = Object.keys(n), i = 0; i < o.length; i++) t.setAttribute("data-" + o[i], n[o[i]])
			}
			catch (a)
			{
			...
			if (!!r && -1 !== r.indexOf("ga4-event-tracker"))
			{
				var s = {
					...
					type: "accordion",
					index: 0,
					index_total: this.$module.querySelectorAll(".govuk-accordion__section").length
				};
		...
		}, e.prototype.addAccordionOpenAllTracking = function()
		{
			this.$module.querySelector(this.showAllControls).addEventListener("click", function(t)
			{
				...
				if (i)
					for (var r in i = JSON.parse(i)) o[r] = i[r];
		...
		}, e.prototype.addAccordionSectionTracking = function(t)
		{
			...
			if (o)
				for (var i in o = JSON.parse(o)) n[i] = o[i];
	...
	}(this, function()
	{
				...
				})(this) || function()
				{
					...
					if ("undefined" != typeof document && "undefined" != typeof window)
					{
						...
						window.Event = Window.prototype.Event = function r(t, e)
						{
							...
							return (n = document.createEventObject()).type = t, n.bubbles = !(!e || e.bubbles === c) && e.bubbles, n.cancelable = !(!e || e.cancelable === c) && e.cancelable, n
						...
						}), "createEvent" in document || (window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function s(t, e)
						{
							...
							c._events || (c._events = {}), c._events[n] || (c._events[n] = function(t)
							{
								var e, n = c._events[t.type].list,
									o = n.slice(),
									i = -1,
									r = o.length;
								for (t.preventDefault = function s()
									...
									}, t.currentTarget = c, t.relatedTarget = t.fromElement || null, t.target = t.target || t.srcElement || c, t.timeStamp = (new Date).getTime(), t.clientX && (t.pageX = t.clientX + document.documentElement.scrollLeft, t.pageY = t.clientY + document.documentElement.scrollTop); ++i < r && !t.cancelImmediate;) i in o && -1 !== u(n, e = o[i]) && "function" == typeof e && e.call(c, t)
		...
		}, t.prototype.polyfillHandleInputs = function(t, n)
		{
			...
			{
				var e = t.target;
				t.keyCode !== i && t.keyCode !== r || "summary" === e.nodeName.toLowerCase() && (t.preventDefault(), e.click ? e.click() : n(t))
			}), t.addEventListener("keyup", function(t)
			{
				var e = t.target;
				t.keyCode === r && "summary" === e.nodeName.toLowerCase() && t.preventDefault()
	...
	{}, window.GOVUK.Modules = window.GOVUK.Modules ||
	{}, window.GOVUK.Modules.GovukErrorSummary = window.GOVUKFrontend.ErrorSummary, window.GOVUK = window.GOVUK ||
	{}, window.GOVUK.Modules = window.GOVUK.Modules ||
	{},
	function(t)
	{
	...
	{}, window.GOVUK.Modules = window.GOVUK.Modules ||
	{}, window.GOVUK.Modules.GovukRadios = window.GOVUKFrontend.Radios, window.GOVUK = window.GOVUK ||
	{}, window.GOVUK.Modules = window.GOVUK.Modules ||
	{},
	function(t)
	{
				...
				if (4 === s.readyState)
				{
					if (200 === s.status)
					{
						...
						if (t && this.responseIsJSON(t))
						{
							...
							!0 === e ? (this.$module.setAttribute("data-track-action", "Unsubscribe-button" + r), i && (this.$module.querySelector(".gem-c-single-page-notication-button__text").textContent = o)) : (this.$module.setAttribute("data-track-action", "Subscribe-button" + r), i && (this.$module.querySelector(".gem-c-single-page-notication-button__text").textContent = n))
						}
					}
					this.makeVisible(this.$module)
				}
	...
	function(t)
	{
		...
		}, e.prototype.addShowHideToggle = function()
		{
			for (var t = 0; t < this.$module.stepHeaders.length; t++)
			{
				...
				if (!e.querySelectorAll(".js-toggle-link").length)
				{
					...
					n.className = "gem-c-step-nav__toggle-link js-toggle-link govuk-!-display-none-print", o.className = "gem-c-step-nav__button-text js-toggle-link-text", i.className = "gem-c-step-nav__chevron js-toggle-link-icon", r.className = "gem-c-step-nav__toggle-link-focus", s.className = "govuk-visually-hidden", n.appendChild(r), r.appendChild(i), r.appendChild(o), s.innerHTML = " this section", n.appendChild(s), e.querySelectorAll(".js-step-title-button")[0].appendChild(n)
				}
			}
		...
		}, e.prototype.rememberStepState = function(t)
		{
			if (this.$module.rememberShownStep)
			{
				...
				{
					var o = e.indexOf(n); - 1 < o && e.splice(o, 1)
				}
		...
		}, e.prototype.StepNavTracker = function(t, e, n)
		{
			...
			{
				window.GOVUK.analytics && window.GOVUK.analytics.trackEvent && ((n = n ||
				{}).dimension26 = n.dimension26 || this.totalSteps.toString(), n.dimension27 = n.dimension27 || this.totalLinks.toString(), n.dimension96 = n.dimension96 || this.uniqueId, window.GOVUK.analytics.trackEvent(t, e, n))
			}
		}, t.Gemstepnav = e
	}(window.GOVUK.Modules), window.GOVUK = window.GOVUK ||
	{}, window.GOVUK.Modules = window.GOVUK.Modules ||
