...
function setInitialText() {
  if ('text' in search) {
    ...
    return fetch('./public/javascripts/marked/demo/initial.md')
...
function setInitialQuickref() {
  return fetch('./public/javascripts/marked/demo/quickref.md')
    .then(function(res) { return res.text(); })
    .then(function(text) {
...
function messageWorker(message) {
  if (!markedWorker || markedWorker.working) {
    ...
    markedWorker = new Worker('./public/javascripts/marked/demo/worker.js');
